using TourVisio.Hotel.Client.Data;
...
namespace TourVisio.Hotel.Client
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc().SetCompatibilityVersion(CompatibilityVersion.Version_3_0) ;  //mvc servisi eklendi
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseMvc(routes =>       //yönlendirme=route ,mvc yi kullanabilmek için
            {
                routes.MapRoute(
                    name: "default",
